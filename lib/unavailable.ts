export const UNAVAILABLE_TITLE = "Page not available in your region";

export const UNAVAILABLE_HEADING = "This page isn't available in your country";

export const UNAVAILABLE_DESCRIPTION =
