...
export const metadata: Metadata = pageMetadata({
    title: "Free Open Source Tools — Practice Integration & Earn Points",
    description: `Integrate ${OSS_TOOL_COUNT} free open-source tools from GitHub. Hands-on practice with React, Next.js, Tailwind, Docker, and more. Push to GitHub and earn up to ${MAX_OSS_POINTS} integration points.`,
    path: "/opensource",
    keywords: ["open source tools", "github integration", "learn react", "free developer tools", "oss practice"],
});
        ...
        <div className="font-jakarta bg-page min-h-screen pt-28 pb-20">
            <JsonLd
                data={{
                    ...
                    description: "Practice integrating free open-source tools and push to GitHub for points.",
                }}
            />
            <div className="max-w-6xl mx-auto px-6 md:px-12">
                <span className="inline-flex px-4 py-1.5 bg-[#FFE55E] rounded-full font-bold text-black text-xs mb-4">
                    {OSS_TOOL_COUNT} Tools · {MAX_OSS_POINTS} Max Points
                </span>
                <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    Open Source Integration Hub
                </h1>
                <p className="text-lg text-gray-500 font-medium mb-8 max-w-3xl leading-relaxed">
                    Every tool on this page is free, open-source, and hosted on GitHub. Practice real integration
                    in a live workspace, push your code to GitHub, and earn{" "}
                    <strong className="text-gray-800">integration points</strong> for each one you complete.
                </p>

                <div className="grid sm:grid-cols-3 gap-4 mb-12">
                    {[
                        { step: "1", title: "Pick a tool", desc: "React, Tailwind, Docker, Supabase — 20+ OSS projects" },
                        { step: "2", title: "Integrate live", desc: "Edit real config files, run tests, commit in the workspace" },
                        { step: "3", title: "Push to GitHub", desc: "Auto-push via GitHub OAuth or verify your manual push" },
                    ].map((item) => (
